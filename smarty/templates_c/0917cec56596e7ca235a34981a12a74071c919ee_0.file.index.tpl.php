<?php
/* Smarty version 3.1.32, created on 2018-10-14 10:58:55
  from 'D:\xampp\htdocs\prova\smarty\templates\index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bc3054f76a517_41099309',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0917cec56596e7ca235a34981a12a74071c919ee' => 
    array (
      0 => 'D:\\xampp\\htdocs\\prova\\smarty\\templates\\index.tpl',
      1 => 1539507530,
      2 => 'file',
    ),
  ),
...
function content_5bc3054f76a517_41099309 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="img/prova.png" alt="logo"></a>
    </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="7000">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="img/carousel1.png" alt="WWS" width="1200" height="400">
      ...
      <div class="item">
        <img src="img/carousel2.png" alt="8ful 8" width="1200" height="400">
        <div class="carousel-caption">
      ...
      <div class="item">
        <img src="img/carousel3.png" alt="NGNL0" width="1200" height="400">
        <div class="carousel-caption">
    ...
    <div class="col-sm-6">
	   <div class="row">
	      <div class="media col-md-3 col-md-offset-1">           
              <img class="media-object img-rounded img-responsive"  src="img/dju.jpg" alt="DjUnch" >            
          </div>
          <div class="col-md-6">
	   ...
	   <div class="row">
	      <div class="media col-md-3 col-md-offset-1">
              <img class="media-object img-rounded img-responsive"  src="img/aveng.jpg" alt="DjUnch" >
          </div>
          <div class="col-md-6">
...
<footer class="text-center"> <br>
  <div class="col-sm-4 "></br></br><img src="img/if.png" alt="IF" id="IF">
  </div>
  <div class="col-sm-4 ">
  <h5>Chi siamo</h5>
