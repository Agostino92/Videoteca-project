...
class FPersistantManager {
    ...
    /**
     * Inizializza un oggetto FDatabase, Metodo che evita
    ...
    static function getInstance() : FPersistantManager
    {
        ...
        return static::$instance;
                   ...
                   /** Caricamento Informazioni dal DBMS **/ 
     ...
     * $target puo essere specificato per la seguente classe:
     *  - EFilm ( FTarget::LOAD_FILM_LIST ) questa funzione carica la filmlist dell utente
     ...
     * di una ricerca da parte dell'utente, relativa a film utilizzando uno o piu 
